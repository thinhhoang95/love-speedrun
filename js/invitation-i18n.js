...
const translations = {
  ...
  en: {
    ...
    menu_open: 'Open menu', menu_close: 'Close menu', nav_invitation: 'Invitation', nav_gallery: 'Gallery', nav_menu: 'Menu', nav_countdown: 'Countdown', nav_schedule: 'Schedule',
  ...
  fr: {
    ...
    menu_open: 'Ouvrir le menu', menu_close: 'Fermer le menu', nav_invitation: 'Faire-part', nav_gallery: 'Galerie', nav_menu: 'Menu', nav_countdown: 'Compte à rebours', nav_schedule: 'Programme',
  ...
  ja: {
    ...
    menu_open: 'メニューを開く', menu_close: 'メニューを閉じる', nav_invitation: 'ご招待', nav_gallery: 'フォトギャラリー', nav_menu: 'お料理', nav_countdown: 'カウントダウン', nav_schedule: 'プログラム',
